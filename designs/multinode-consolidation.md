...
The 100-candidate cap means that in large clusters, only the 100 cheapest-to-disrupt nodes are considered. Savings among higher-cost nodes beyond this cap are invisible to multi-node evaluation. See [kubernetes-sigs/karpenter#2814](https://github.com/kubernetes-sigs/karpenter/issues/2814) for a related discussion on NodePool-aware candidate selection.
